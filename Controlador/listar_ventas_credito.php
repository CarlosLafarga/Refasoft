...
WHERE DATE(venta_articulos.fecha_venta) =  '" . $fecha . "' AND tipo_pago ='credito'  AND ventas.cancelado != 1 AND venta_articulos.devolucion != 1 AND cantidad > 0 ORDER BY no_tiket ";
